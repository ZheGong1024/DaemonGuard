...
public class IntentWrapper {
  ...
  public static List<IntentWrapper> getIntentWrapperList() {
    if (sIntentWrapperList == null) {
      ...
      if (!Daemon.getInstance().isInitialized) return new ArrayList<>();

      sIntentWrapperList = new ArrayList<>();

      //Android 7.0+ Doze 模式
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
        PowerManager pm = (PowerManager) Daemon.getInstance().mApplication.getSystemService(
            Context.POWER_SERVICE);
        boolean ignoringBatteryOptimizations =
            pm.isIgnoringBatteryOptimizations(Daemon.getInstance().mApplication.getPackageName());
        if (!ignoringBatteryOptimizations) {
          Intent dozeIntent = new Intent(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS);
          dozeIntent.setData(
              Uri.parse("package:" + Daemon.getInstance().mApplication.getPackageName()));
      ...
      huaweiGodIntent.setComponent(new ComponentName("com.huawei.systemmanager",
      ...
      xiaomiGodIntent.setComponent(new ComponentName("com.miui.powerkeeper",
          "com.miui.powerkeeper.ui.HiddenAppsConfigActivity"));
      xiaomiGodIntent.putExtra("package_name", Daemon.getInstance().mApplication.getPackageName());
      ...
      //三星 5.0/5.1 自启动应用程序管理
      Intent samsungLIntent = Daemon.getInstance().mApplication.getPackageManager()
      ...
      samsungMIntent.setComponent(new ComponentName("com.samsung.android.sm_cn",
      ...
      meizuIntent.putExtra("packageName", Daemon.getInstance().mApplication.getPackageName());
      sIntentWrapperList.add(new IntentWrapper(meizuIntent, MEIZU));

      //魅族 待机耗电管理
      Intent meizuGodIntent = new Intent();
      meizuGodIntent.setComponent(
          new ComponentName("com.meizu.safe", "com.meizu.safe.powerui.PowerAppPermissionActivity"));
      ...
      oppoOldIntent.setComponent(new ComponentName("com.color.safecenter",
      ...
      vivoGodIntent.setComponent(new ComponentName("com.vivo.abe",
          "com.vivo.applicationbehaviorengine.ui.ExcessivePowerManagerActivity"));
      sIntentWrapperList.add(new IntentWrapper(vivoGodIntent, VIVO_GOD));

      //金立 应用自启
      Intent gioneeIntent = new Intent();
      gioneeIntent.setComponent(
          new ComponentName("com.gionee.softmanager", "com.gionee.softmanager.MainActivity"));
      sIntentWrapperList.add(new IntentWrapper(gioneeIntent, GIONEE));

      //乐视 自启动管理
      Intent letvIntent = new Intent();
      letvIntent.setComponent(new ComponentName("com.letv.android.letvsafe",
          "com.letv.android.letvsafe.AutobootManageActivity"));
      sIntentWrapperList.add(new IntentWrapper(letvIntent, LETV));

      //乐视 应用保护
      Intent letvGodIntent = new Intent();
      letvGodIntent.setComponent(new ComponentName("com.letv.android.letvsafe",
      ...
      coolpadIntent.setComponent(new ComponentName("com.yulong.android.security",
      ...
      lenovoIntent.setComponent(new ComponentName("com.lenovo.security",
          "com.lenovo.security.purebackground.PureBackgroundActivity"));
      sIntentWrapperList.add(new IntentWrapper(lenovoIntent, LENOVO));

      //联想 后台耗电优化
      Intent lenovoGodIntent = new Intent();
      lenovoGodIntent.setComponent(new ComponentName("com.lenovo.powersetting",
      ...
      zteIntent.setComponent(new ComponentName("com.zte.heartyservice",
      ...
      zteGodIntent.setComponent(new ComponentName("com.zte.heartyservice",
  ...
  public static String getApplicationName() {
    if (sApplicationName == null) {
      ...
      ApplicationInfo ai;
      try {
        pm = Daemon.getInstance().mApplication.getPackageManager();
        ai = pm.getApplicationInfo(Daemon.getInstance().mApplication.getPackageName(), 0);
        sApplicationName = pm.getApplicationLabel(ai).toString();
      } catch (PackageManager.NameNotFoundException e) {
        e.printStackTrace();
        sApplicationName = Daemon.getInstance().mApplication.getPackageName();
      }
    }
   ...
   */
  @NonNull public static List<IntentWrapper> whiteListMatters(final Activity a, String reason) {
  ...
  protected boolean doesActivityExists() {
    if (!Daemon.getInstance().isInitialized) return false;
    PackageManager pm = Daemon.getInstance().mApplication.getPackageManager();
